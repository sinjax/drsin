...
class AndroidtestController(BaseController):
	def useragent(self):
		...
		if len(andBit) > 0:
			...
			if "2.1" in andBit:
				return redirect("http://padkite.com/PadKite-RC7-v1_00-eclair")
			elif "2.2" in andBit: # froyo
				if "r2" in andBit:
					return redirect("http://padkite.com/PadKite-RC7-v1_00-froyo-FRG83D")
				else:
					return redirect("http://padkite.com/PadKite-RC7-v1_00-froyo")
